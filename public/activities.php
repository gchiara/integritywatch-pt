...
<head>
    ...
    <meta property="og:url" content="https://integritywatch.transparencia.pt/activities.php" />
    ...
    <link rel="stylesheet" href="static/tab_b.css?v=9">
</head>
<body>
      ...
      <div class="container-fluid dashboard-container-outer">
        <div class="row dashboard-container">
          ...
          <div class="col-md-12 chart-col acttype-select-container">
            <a href="./activities.php" class="link-button active">Cargos</a>
            <a href="./activities-other.php" class="link-button">Outros Interesses</a>
    ...
    <script src="static/tab_b.js?v=9"></script>
