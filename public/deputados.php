...
<head>
    ...
    <title>Integrity Watch PT – Deputados</title>
    <!-- Add twitter and og meta here -->
    <meta property="og:url" content="https://integritywatch.transparencia.pt" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Integrity Watch PT – Deputados" />
    ...
    <link rel="stylesheet" href="static/tab_a.css?v=12">
</head>
<body>
          ...
          <div class="col-md-4 chart-col">
            <div class="boxed-container chart-container tab_a_map">
              ...
              <div class="map-buttons">
                <button id="AÇORES">AÇORES</button>
                <button id="MADEIRA">MADEIRA</button>
        ...
        <div class="row">
          ...
          <div class="footer-col col-sm-8 footer-counts">
            ...
            <div class="count-box count-box-activities">
              <div class="filter-count nbactivities">0</div>de <strong class="total-count-act">0</strong> interesses
            </div>
          </div>
        </div>
        <!-- Reset filters -->
    ...
    <script src="static/tab_a.js?v=12"></script>
