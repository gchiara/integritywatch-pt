<nav class="navbar navbar-expand-lg navbar-light bg-light" id="iw-nav">
  <a class="navbar-brand" href="https://integritywatch.transparencia.pt" target="_blank"><img src="./images/ti_logo_pt.png" alt="" /> </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a href="./index.php" class="nav-link" :class="{active: page == 'tabA'}">Deputados</a>
      </li>
      <li class="nav-item">
        <a href="./activities.php" class="nav-link" :class="{active: page == 'tabB'}">Interesses</a>
      </li>
    </ul>
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a href="./about" class="nav-link">Sobre o Integrity Watch Portugal</a>
      </li>
      <!--
      <li class="nav-item">
