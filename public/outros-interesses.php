...
<head>
    ...
    <title>Integrity Watch PT – Interesses: Outros</title>
    <!-- Add twitter and og meta here -->
    <meta property="og:url" content="https://integritywatch.transparencia.pt/outros-interesses.php" />
    ...
    <link rel="stylesheet" href="static/tab_b2.css?v=10">
</head>
<body>
      ...
      <div class="container-fluid dashboard-container-outer">
        <div class="row dashboard-container">
          ...
          <div class="col-md-12 chart-col acttype-select-container">
            <a :href="'./cargos.php?legislatura='+legislature" class="link-button">Cargos</a>
            <a :href="'./outros-interesses.php?legislatura='+legislature" class="link-button active">Outros Interesses</a>
    ...
    <script src="static/tab_b2.js?v=10"></script>
