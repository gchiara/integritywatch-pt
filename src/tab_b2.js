...
var vuedata = {
  ...
  charts: {
    topMps: {
      ...
      info: 'Top 10 dos Deputados portugueses com mais interesses declarados relativos a apoios ou benefícios, serviços prestados, sociedades detidas pelo próprio e/ou pelo cônjuge, e outras situações.'
    },
    type: {
      title: 'Tipo de Interesse',
      info: 'Tipos de interesses declarados pelos Deputados relativos a apoios ou benefícios, serviços prestados, sociedades detidas pelo próprio e/ou pelo cônjuge, e outras situações.'
    },
    natureza: {
      title: 'Top 15: Natureza',
      info: 'Top 15 da natureza dos interesses declarados pelos Deputados relativos a apoios ou benefícios, serviços prestados, sociedades detidas pelo próprio e/ou pelo cônjuge, e outras situações.'
    },
   /*
    cloud: {
      title: 'Natureza',
      info: 'Natureza dos interesses declarados pelos Deputados relativos a apoios ou benefícios, serviços prestados, sociedades detidas pelo próprio e/ou pelo cônjuge, e outras situações.'
    },
    */
    org: {
      title: 'Top 10: Entidades',
      info: 'Top 10 das entidades sobre as quais os Deputados portugueses têm mais interesses declarados relativos a apoios ou benefícios, serviços prestados, sociedades detidas pelo próprio e/ou pelo cônjuge, e outras situações.'
    },
    mainTable: {
      chart: null,
      type: 'table',
...
json(activitiesDataset, (err, activities) => {
  ...
  var activities = _.filter(activities, function(x, index) {
    return x.activityType == "GenSociedade" || x.activityType == "GenServicoPrestado" || x.activityType == "GenApoios";
  });
  ...
  _.each(activities, function (d) {
    ...
    d.EntidadeSociedade = "";
    if(d.Entidade) { 
      d.EntidadeSociedade = d.Entidade;
    } else if(d.Sociedade) {
      d.EntidadeSociedade = d.Sociedade;
    }
    if(!d.Natureza) {
      d.Natureza = "N/A";
      if(d.NaturezaBeneficio) {
        d.Natureza = d.NaturezaBeneficio;
      }
    }
    d.naturezaString = d.Natureza.toLowerCase().trim();
    d.naturezaString = d.naturezaString[0].toUpperCase() + d.naturezaString.substring(1);
    d.typeString = d.activityType;
    if(d.activityType == "GenSociedade") {
      d.typeString = "Sociedade";
    } else if(d.activityType == "GenServicoPrestado") {
      d.typeString = "Serviço Prestado";
    } else if(d.activityType == "GenApoios") {
      d.typeString = "Apoios";
    }
  });
  ...
  var searchDimension = ndx.dimension(function (d) {
      var entryString = d.NomeIdentificacao + " " + d.activityType + " " + d.Natureza + " " + d.EntidadeSociedade;
  ...
  var createWordCloud = function() {
    ...
    .font("Impact")
    .scale(d3.scaleLinear().domain([2,20]).range([11, 30]))
    .stopWords(/^(V|Z|v|z|o|O|S|s|in|za|de)$/)
    .onClick(function(d){setword(d.key);})
    .textAccessor(function(d) {return d.naturezaString;});
